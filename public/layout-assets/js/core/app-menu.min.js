!function (e, n, a) {
    ...
    a.app.menu = {
        ...
        expand: function () {
            !1 === this.expanded && ("vertical-menu-modern" == i.data("menu") && a(".modern-nav-toggle").find(".collapse-toggle-icon").replaceWith(feather.icons.menu.toSvg({class: "d-none d-xl-block collapse-toggle-icon primary font-medium-4"})), this.transit((function () {
