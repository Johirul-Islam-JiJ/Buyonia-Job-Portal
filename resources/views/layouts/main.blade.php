...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('layout-assets/css/core/menu/menu-types/vertical-menu.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('layout-assets/css/plugins/extensions/ext-component-toastr.css') }}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow mt-0">
        ...
        <span class="nav navbar-nav align-items-center mt-1 mr-1 p-0">
            ...
            <span class="nav-item dropdown dropdown-user p-0"><a class="nav-link dropdown-toggle dropdown-user-link p-0"
                    ...
                    <div class="user-nav d-sm-flex d-none p-0">
                        <span
                            class="user-name font-weight-bolder  bg-light-success p-1 rounded">{{ Auth::user()->name }}
                ...
                <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="dropdown-user">
                    <a class="dropdown-item" href="{{ route('setting.index') }}">
                        <i class="mr-50" data-feather="settings"></i> Settings</a><a class="dropdown-item"
                        href="{{ route('logout') }}"
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item {{ request()->routeIs('home') ? 'active' : '' }}"><a
                        class="d-flex align-items-center " href="{{ url('/home') }}"><i
                ...
                <li class="nav-item"><a class="d-flex align-items-center " href="{{ route('department.index') }}"><i
                            data-feather="layers"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Department</span></a>
                </li>
                ...
                <li class="nav-item"><a class="d-flex align-items-center "
                        href="{{ route('tasks.index') }}"><i class="fa fa-tasks" aria-hidden="true"></i><span
                            class="menu-title text-truncate" data-i18n="Dashboards">Tasks</span></a>

                </li>
                <li class="nav-item"><a class="d-flex align-items-center " href="{{ route('resume.index') }}"><i
                            data-feather="book-open"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Resume Builder</span></a>
                </li>
                ...
                @can('role-management')
                    <li class="nav-item {{ request()->routeIs('role.*') ? 'active' : '' }}"><a
                            class="d-flex align-items-center " href="{{ route('role.index') }}"><i
                                ...
                                data-i18n="Dashboards">Roles</span></a>

                    </li>
                    <li class="nav-item {{ request()->routeIs('permission.*') ? 'active' : '' }}"><a
                            class="d-flex align-items-center " href="{{ route('permission.index') }}"><i
                                data-feather="shield-off"></i><span class="menu-title text-truncate"
                                data-i18n="Dashboards">Permissions</span></a>

                    </li>
                @endcan
                <li class="nav-item {{ request()->routeIs('setting.index') ? 'active' : '' }}"><a
                        class="d-flex align-items-center " href="{{ route('setting.index') }}"><i
                            data-feather="settings"></i><span class="menu-title text-truncate"
                            data-i18n="Dashboards">Settings</span></a>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0 text-center"><span>Developed By Buyonia Limited | COPYRIGHT &copy;
                {{ $existing_setting->copyright }}</span></p>
    </footer>
