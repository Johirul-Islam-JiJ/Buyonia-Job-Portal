    ...
    <div class="app-content content">
        ...
        <div class="row match-height">
            ...
            <div class="col-xl-12 col-md-6 col-12 mx-auto">
                ...
                @endif
                <div class="mb-1">
                    <a class="btn btn-primary btn-sm" href="{{ route('resume.create') }}">Add New Job</a>
                </div>
                <div class="card">
                                ...
                                <thead>
                                    ...
                                    @foreach ($resumes as $resume)
                                        <tr>
                                            ...
                                            <td>{{ $resume->image }}</td>
                                            <td>{{ $resume->title }}</td>
                                            <td>{{ $resume->primary_email }}</td>
                                            <td>{{ $resume->primary_phone }}</td>


                                            <td class='{{ $resume->deleted_at != null ? 'text-danger' : 'text-success' }}'>
                                                {{ $resume->deleted_at != null ? 'Inactive' : 'Active' }}
                                            </td>
                                            <td>
