    ...
    <div class="app-content content">
        ...
        <div class="row match-height">
            ...
            <div class="col-xl-12 col-md-6 col-12 mx-auto">
                ...
                @endif
                <div class="mb-1">
                    <a class="btn btn-primary btn-sm" href="{{ route('department.create') }}">Add New Department</a>
                </div>
                                ...
                                <thead>
                                    ...
                                    @foreach ($department as $dep)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $dep->name }}</td>
                                            <td class='{{ $dep->deleted_at != null ? 'text-danger' : 'text-success' }}'>
                                                {{ $dep->deleted_at != null ? 'Inactive' : 'Active' }}
                                            </td>
                                            <td>
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    ...
                                                    @else
                                                        <a class="text-success mr-2"
                                                            href="{{ route('department.edit', $dep) }}"
                                                            data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                                data-feather="edit"></i></a>

                                                        <form action="{{ route('department.destroy', $dep) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
