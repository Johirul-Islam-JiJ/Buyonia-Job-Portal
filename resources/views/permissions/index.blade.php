                            ...
                            <table class="table text-center"
                                ...
                                <tr>
                                    ...
                                    <th onclick="sortTable(1)"
                                        class="cursor-pointer">permission Name
                                        <i data-feather="arrow-up"></i><i data-feather="arrow-down"></i></th>
                                    <th>Status</th>
                                    <th>Actions</th>
                                </tr>
                                @foreach($all_permissions as $index=>$permissions)
                                    <tr>
                                        <td>{{$index+$all_permissions->firstItem()}}</td>
                                        <td>{{$permissions->name}}</td>
                                        <td class='{{ $permissions->deleted_at != null ? "text-danger" : "text-success"}}'>
                                            {{ $permissions->deleted_at != null ? 'Inactive' : 'Active' }}
                                        </td>
                                        <td>
                                            ...
                                            <div class="btn-group"
                                                ...
                                                @if($permissions->deleted_at != null)

                                                    <a class="text-success mr-2"
                                                       href="{{ route('permission.restore',$permissions->id) }}"
                                                       data-toggle="tooltip"
                                                       data-placement="top"
                                                                                        ...
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                ...
                                                                                                <a class="btn btn-danger mr-2"
                                                                                                   href="{{ route('permission.forceDelete',$permissions->id) }}"
                                                                                                   data-toggle="tooltip"
                                                                                                   data-placement="top"
                                                ...
                                                @else
                                                    ...
                                                    <a class="text-success mr-2"
                                                       href="{{ route('permission.edit',$permissions->id) }}"
                                                       data-toggle="tooltip"
                                                       data-placement="top"
