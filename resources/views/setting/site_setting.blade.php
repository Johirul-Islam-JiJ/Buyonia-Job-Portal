                        ...
                        <form action="{{ route('setting.update', 1) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" col-6">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" placeholder="Site Name"
                                        value="{{ old('name') ?? $site_setting->name }}">
                                    @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class=" col-6">
                                    ...
                                    <input class="form-control @error('whatsapp') is-invalid @enderror" type="text"
                                        ...
                                        value="{{ old('whatsapp') ?? $site_setting->whatsapp }}">
                                    @error('whatsapp')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class=" col-6">
                                    ...
                                    <input class="form-control @error('working_hour') is-invalid @enderror" type="text"
                                        name="working_hour" placeholder="working Hour"
                                        value="{{ old('working_hour') ?? $site_setting->working_hour }}">
                                    @error('working_hour')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control @error('linkedin') is-invalid @enderror" type="text"
                                        ...
                                        value="{{ old('linkedin') ?? $site_setting->linkedin }}">
                                    @error('linkedin')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class=" col-6">
                                    ...
                                    @enderror"
                                        ...
                                        value="{{ old('twitter') ?? $site_setting->twitter }}">
                                    @error('twitter')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                        rows="2" placeholder="Short Description">{{ old('description') ?? $site_setting->description }}</textarea>
                                    @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control @error('copyright') is-invalid @enderror" id="copyright" name="copyright"
                                        rows="2" placeholder="Copyright Details">{{ old('copyright') ?? $site_setting->copyright }}</textarea>
                                    @error('copyright')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
