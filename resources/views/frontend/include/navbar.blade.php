<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"><span class="brand-logo">
                ...
                <img class="brand-logo" src="/images/{{ $existing_setting->logo }}">
            </span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link nav-list {{ request()->routeIs('homepage') ? 'nav-font-color' : '' }}"
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @guest
                    @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link login" href="{{ url('/login')}}">Admin Login</a>
                        </li>
                    @endif
