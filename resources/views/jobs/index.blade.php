                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="btn-group mb-1 float-right">
                                <select class="form-control mr-1" name="designation" id="designation"
                                    onchange="this.form.submit()">
                                    <option value="">Designation</option>
                                    @foreach ($job->unique('designation') as $j)
                                        <option value="{{ $j->designation }}"
                                            {{ request('designation') == $j->designation ? 'selected' : '' }}>
                                            {{ $j->designation }}
                                        </option>
                                    @endforeach
                                </select>
                                <select class="form-control mr-1" name="department" id="department"
                                    onchange="this.form.submit()">
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    @if ($job->deleted_at != null)
                                                        <a class="text-success mr-2"
                                                            href="{{ route('jobs.restore', $job) }}" data-toggle="tooltip"
                                                    ...
                                                    @else
                                                        <a class="text-success mr-2"
                                                            href="{{ route('jobs.show', $job) }}" data-toggle="tooltip"
                                                            data-placement="top" title="Show"><i
                                                                data-feather="eye"></i></a>

                                                        <a class="text-success mr-2"
                                                            href="{{ route('jobs.edit', $job) }}" data-toggle="tooltip"
